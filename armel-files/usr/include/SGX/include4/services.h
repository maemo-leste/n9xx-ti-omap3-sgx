...
/*
       Flags for PVRSRVRequestHWRecEvent
       PVRSRV_HWREC_ANY_CONTEXTS       -       Notify of a HW recovery event on any memory context
*/
#define PVRSRV_HWREC_ANY_CONTEXTS                              0x00000001
/******************************************************************************
 * Enums
 *****************************************************************************/
...
IMG_IMPORT
PVRSRV_ERROR IMG_CALLCONV PVRSRVCheckHWRecovery(IMG_CONST PVRSRV_CONNECTION *psConnection,
								IMG_HANDLE hDevMemContext,
								IMG_BOOL *bHasHWRecovery);
IMG_IMPORT PVRSRV_ERROR IMG_CALLCONV PVRSRVRequestHWRecEvent(IMG_CONST PVRSRV_CONNECTION *psConnection,
								IMG_HANDLE hDevMemContext,
								IMG_UINT32 ui32Flags);
IMG_IMPORT PVRSRV_ERROR IMG_CALLCONV PVRSRVHWRecDumpComplete(IMG_CONST PVRSRV_CONNECTION *psConnection);
IMG_IMPORT IMG_VOID IMG_CALLCONV PVRSRVNotifyHWRecovery(void);
...
/******************************************************************************
 * HW recovery mangement API
 *****************************************************************************/
typedef IMG_VOID (*pfnHWRecCallback)(IMG_HANDLE hData);

IMG_HANDLE PVRSRVRegisterHWRecoveryCallback(pfnHWRecCallback Callback, IMG_HANDLE hData,
					    const PVRSRV_DEV_DATA *psDevData, IMG_HANDLE hDevMemContext,
					    IMG_UINT32 ui32Flags);
IMG_VOID PVRSRVUnregisterHWRecoveryCallback(IMG_HANDLE hItem);
IMG_HANDLE PVRSRVCreateHWRecoveryHandler(IMG_CONST PVRSRV_DEV_DATA *psDevData, IMG_HANDLE hDevMemContext, IMG_UINT32 ui32Flags);
IMG_VOID PVRSRVDestroyHWRecoveryHandler(IMG_HANDLE hData);
