...
#define GL_TEXTURE_BINDING_STREAM_IMG  							0x600D
#define GL_SAMPLER_STREAM_IMG  									0x600E
#endif
...
/* IMG_program_binary - FIXME: experimental enum */
#ifndef GL_IMG_program_binary
#define GL_SGX_PROGRAM_BINARY_IMG								0x600F 
#endif
/*------------------------------------------------------------------------*
...
GL_API_EXT void GL_APIENTRY glMultiDrawElementsEXT(GLenum mode, const GLsizei *count, GLenum type, const GLvoid* *indices, GLsizei primcount);
#endif
